...
function sendToBlockchain(address, seed, declaration) {
    // address just needs to be 81 trytes to be valid - randomly generate and then link to user in database 
    //const address = 
    //'HEQLOWORLDHELLOWORLDHELLOWORLDHELLOWORLDHELLOWORLDHELLOWORLDHELLOWORLDHELLOWOR99D';

    // seed also needs to be 81 characters - randomly generate and then link to user in database
    // const seed = 
...
function extractFromBlockchain(tailTransactionHash) {
...
function createNewAddress(seed) {
